...
///
/// ```rust,ignore
/// use cognis::document_transformers::metadata::MetadataAdder;
///
...
///
/// ```rust,ignore
/// use cognis::document_transformers::metadata::{MetadataFilter, MetadataCondition};
///
...
///
/// ```rust,ignore
/// use cognis::document_transformers::metadata::MetadataExtractor;
///
