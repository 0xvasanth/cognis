...
/// ```rust,no_run
/// use std::sync::Arc;
/// use rustchain::chains::summarize::StuffSummarizationChain;
/// use rustchain_core::documents::Document;
///
...
/// ```rust,no_run
/// use std::sync::Arc;
/// use rustchain::chains::summarize::MapReduceSummarizationChain;
/// use rustchain_core::documents::Document;
///
/// # async fn example(llm: Arc<dyn rustchain_core::language_models::chat_model::BaseChatModel>) {
...
/// ```rust,no_run
/// use std::sync::Arc;
/// use rustchain::chains::summarize::RefineSummarizationChain;
/// use rustchain_core::documents::Document;
///
/// # async fn example(llm: Arc<dyn rustchain_core::language_models::chat_model::BaseChatModel>) {
