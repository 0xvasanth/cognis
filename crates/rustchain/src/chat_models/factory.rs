...
//!
//! ```no_run
//! use rustchain::chat_models::factory::{ModelConfig, ChatModelFactory, init_chat_model};
//!
...
///
/// ```no_run
/// use rustchain::chat_models::factory::init_chat_model;
///
    ...
    fn test_factory_constructor_can_fail() {
        ...
        factory.register(
            ...
            Box::new(|_config: ModelConfig| {
                Err(RustChainError::Other("construction failed".into()))
            }),
        );
