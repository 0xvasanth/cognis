...
//!
//! Implements [`cognis2_core::prompts::ExampleSelector`] for example
...
use cognis2_core::prompts::ExampleSelector;
...
/// Async-first variant of [`cognis2_core::prompts::ExampleSelector`].
