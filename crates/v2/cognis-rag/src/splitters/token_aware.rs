//! Token-aware splitter using `cognis2_core`'s pluggable [`Tokenizer`].

use std::sync::Arc;

use crate::document::Document;

// Re-export the canonical trait from cognis2-core so users can write
// `cognis2_rag::Tokenizer` or `cognis2_core::Tokenizer` interchangeably.
pub use cognis2_core::tokenizer::{CharTokenizer, FnTokenizer, Tokenizer};
