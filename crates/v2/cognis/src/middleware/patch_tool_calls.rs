...
use cognis2_core::{Message, Result, ToolCall};
...
mod tests {
    ...
    use async_trait::async_trait;
    use cognis2_core::{AiMessage, Message, RunnableStream};
    ...
    impl LLMProvider for WithToolCall {
        ...
        async fn chat_completion(
            ...
            _: Vec<Message>,
            _: ChatOptions,
        ) -> cognis2_core::Result<ChatResponse> {
            Ok(ChatResponse {
        ...
        async fn chat_completion_stream(
            ...
            _: Vec<Message>,
            _: ChatOptions,
        ) -> cognis2_core::Result<RunnableStream<StreamChunk>> {
            unimplemented!()
        }
        async fn health_check(&self) -> cognis2_core::Result<HealthStatus> {
