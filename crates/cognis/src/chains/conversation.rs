...
use cognis_core::language_models::chat_model::{BaseChatModel, ChatStream};
...
///
/// ```rust,no_run
/// use cognis::chains::ConversationChain;
/// use cognis::memory::ConversationBufferMemory;
/// # use std::sync::Arc;
///
/// # async fn example(model: Arc<dyn cognis_core::language_models::chat_model::BaseChatModel>) {
