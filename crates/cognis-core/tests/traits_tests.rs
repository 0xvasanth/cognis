use cognis_core::agents::{AgentAction, AgentActionMessageLog, AgentFinish, AgentStep};
...
use cognis_core::outputs::Generation;
use cognis_core::prompt_values::{
    ChatPromptValue, ImagePromptValue, PromptValue, StringPromptValue,
};
use cognis_core::stores::{BaseStore, ByteStore, InMemoryByteStore, InMemoryStore};
use serde_json::json;
...
fn agent_action_message_log() {
    let messages = vec![
        ...
        Message::Ai(cognis_core::messages::AIMessage::new("Let me check.")),
    ];
