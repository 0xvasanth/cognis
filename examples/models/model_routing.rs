...
async fn main() -> Result<()> {
    ...
    let r = RoutingProvider::new("router", default_p).route(ProviderRoute::new(
        "long",
        big_p,
    ...
    let short = r
        .chat_completion(vec![Message::human("hi")], Default::default())
        .await?;
    let long = r
        .chat_completion(vec![Message::human("a".repeat(80))], Default::default())
        .await?;
