...
The `examples/` directory contains **23 runnable examples** -- all work without API keys using fake/mock models:
...
| `memory_types` | Buffer, window, summary, entity, and token buffer memory | `cargo run --example memory_types` |
